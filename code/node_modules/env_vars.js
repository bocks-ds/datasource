...
class EnvVars {
    ...
    logLevel = conf.logLevel || 'verbose'
    isProduction = conf.isProduction || undefined
    ...
    constructor() {
        ...
        // this.logger.debug("Initialized Environment Variables")    
        // this.logger.debug("└─", Reflect.ownKeys(this))
    }
}
