...
class DefinitionsBuilder {
  ...
  constructor() {
    ...
    env.logger.debug(1, "Compiling typeDefs...")
    ...
    env.logger.debug(1, "Finished compiling typeDefs.")
  ...
  identify_relational_tables() {
    ...
    env.logger.debug(2, "Supported tables & their supporters:")
    env.logger.debug(2, env.supportedTables)
  }
  ...
  add_support_entry(support_table, supported_table) {
    ...
    env.logger.debug(3, "└─ ", supported_table, "is supported by", support_table)
  }
