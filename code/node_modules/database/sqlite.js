...
LOGGER = new LoggerInstance('database')
...
class SqliteDatasource extends DataSource {
    ...
    _run_complex_query(table, query, log_id='') {
    /*  Generalized find-all-where function
    */
        LOGGER.verbose(`[${log_id}] Querying table ${table} with arguments`)
    ...
    */
    ...
    get_between(table, column, values) {
